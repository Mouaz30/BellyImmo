    ...
    <div id="custom-flowbite-carousel" class="relative w-full mt-16" data-carousel="slide">
        ...
        <div class="relative h-96 md:h-[600px] overflow-hidden rounded-lg">
            ...
            <div class="hidden duration-700 ease-in-out" data-carousel-item="active">
                <img src="{{ asset('storage/images/carroussel0.jpg') }}" 
            ...
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <img src="{{ asset('storage/images/image0.jpg') }}" 
                     class="absolute inset-0 w-full h-full object-cover" 
                     alt="Image 2">
            </div>
        </div>
                    ...
                    @foreach ($biens as $bien)
                        <div class="bg-white rounded-xl shadow hover:shadow-lg transition-all duration-300 overflow-hidden">
                           ...
                           <div class="flex items-center justify-between mb-2">
                                ...
                                {{-- Titre principal --}}
                                <h3 class="text-lg font-semibold text-gray-900 mb-2">{{ $bien->titre }}</h3>

                                {{-- Adresse --}}
                                <p class="text-gray-500 text-sm mb-4">{{ $bien->adresse }}</p>

                                {{-- Description (utilisée pour les caractéristiques) --}}
                                ...
                                <div class="flex gap-2">
                                    <a href="{{ route('biens.show', $bien->id) }}" class="flex-1 text-center bg-blue-600 text-white py-2 px-4 rounded-lg hover:bg-blue-700 text-sm font-medium transition-colors">
                                        Voir détails
                                    </a>
