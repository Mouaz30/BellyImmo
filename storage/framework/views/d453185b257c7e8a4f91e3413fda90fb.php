...
<footer class="bg-gray-900 text-gray-200 pt-14 pb-10 mt-20 border-t border-gray-800">
    ...
    <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div class="col-span-1 md:col-span-2">
            ...
            <div class="flex items-center gap-3">
                <img 
                    src="<?php echo e(asset('storage/images/bellyimmo-logo.png')); ?>"
                    alt="BellyImmo"
        ...
        <div>
            ...
            <ul class="space-y-3">
                <li>
                    <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-2 hover:text-white transition">
    ...
    <div class="border-t border-gray-800 mt-12 pt-5 text-center text-gray-400 text-sm">
        © <?php echo e(date('Y')); ?> BellyImmo — Tous droits réservés.
    </div>
...
<?php /**PATH C:\laragon\www\ProjetImmobilier\resources\views/layouts/footer.blade.php ENDPATH**/ ?>