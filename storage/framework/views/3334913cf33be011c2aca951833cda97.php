    ...
    <div class="relative w-full h-[650px] mt-16">
        ...
        <div id="custom-flowbite-carousel" class="relative h-full w-full" data-carousel="slide">
            ...
            <?php $__currentLoopData = [
                ...
                <div class="hidden duration-700 ease-in-out" data-carousel-item="<?php echo e($loop->first ? 'active' : ''); ?>">
                    <img src="<?php echo e(asset('storage/images/' . $img)); ?>" 
        ...
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                ...
                <div class="bg-gray-50 hover:bg-gray-100 rounded-xl p-10 text-center shadow-lg transition cursor-pointer group">
                    <i data-lucide="<?php echo e($icon); ?>" class="w-12 h-12 mx-auto mb-4 text-primary group-hover:scale-110 transition"></i>
                    <p class="font-semibold text-lg"><?php echo e($label); ?></p>
                </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
                ...
                <div class="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition overflow-hidden">
                    ...
                    <div class="relative w-full h-56">
                        <?php $image = $bien->illustrations->first(); ?>
                        ...
                        <div class="absolute top-3 left-3 bg-primary text-white text-xs px-3 py-1 rounded-full shadow">
                            <?php echo e(ucfirst($bien->mode_transaction->value)); ?>

                        </div>

                        <div class="absolute top-3 right-3 text-xs px-3 py-1 rounded-full shadow
                            <?php if($bien->statut->value === 'disponible'): ?> bg-green-600 text-white
                            <?php elseif($bien->statut->value === 'reserve'): ?> bg-yellow-500 text-white
                            <?php elseif($bien->statut->value === 'vendu'): ?> bg-gray-700 text-white
                            <?php elseif($bien->statut->value === 'loue'): ?> bg-blue-600 text-white
                            <?php endif; ?>">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-primary font-bold text-2xl">
                            ...
                            <?php if($bien->mode_transaction->value === 'location'): ?> / mois <?php endif; ?>
                        </p>

                        <h3 class="text-xl font-semibold mt-2"><?php echo e($bien->titre); ?></h3>
                        <p class="text-gray-500 text-sm"><?php echo e($bien->adresse); ?></p>

                        <p class="text-gray-600 text-sm mt-3 line-clamp-2">
                            <?php echo e(Str::limit(strip_tags($bien->description), 100)); ?>

                        </p>

                        <div class="flex gap-3 mt-5">
                            <a href="<?php echo e(route('biens.show', $bien->id)); ?>"
  ...
  <section class="py-24 bg-gradient-to-b from-white to-gray-50">
    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$title, $icon, $desc, $color]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

            <div class="group bg-white p-10 rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100
                        hover:-translate-y-2">

                
                <div class="w-20 h-20 mx-auto flex items-center justify-center rounded-full <?php echo e($color); ?> 
                            group-hover:scale-110 transition-transform duration-300">
                    <i data-lucide="<?php echo e($icon); ?>" class="w-10 h-10"></i>
                </div>

                
                <h3 class="text-2xl font-bold text-gray-900 mt-8"><?php echo e($title); ?></h3>

                
                <p class="text-gray-600 mt-4"><?php echo e($desc); ?></p>
    ...
    <section class="py-20 bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-6 text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10 mt-14">
                ...
                ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$name, $comment, $img]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                <div class="bg-white rounded-2xl p-10 shadow-lg border border-gray-100 hover:shadow-xl transition">
                    <p class="text-gray-700 italic text-lg">“<?php echo e($comment); ?>”</p>

                    <div class="flex items-center gap-4 mt-6 justify-center">
                        <img src="<?php echo e($img); ?>" class="w-14 h-14 rounded-full object-cover shadow">
                        <div>
