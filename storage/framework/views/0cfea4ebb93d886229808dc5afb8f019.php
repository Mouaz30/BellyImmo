...
<?php endif; ?>
        ...
        <div class="block mt-4">
            ...
            <span class="ms-2 text-sm text-gray-700"><?php echo e(__('Se souvenir de moi')); ?></span>
            </label>
        </div>

        <div class="flex items-center justify-end mt-4">
            <?php if(Route::has('password.request')): ?>
                <a class="underline text-sm text-gray-700 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="<?php echo e(route('password.request')); ?>">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\ProjetImmobilier\resources\views/auth/login.blade.php ENDPATH**/ ?>